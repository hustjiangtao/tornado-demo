...
Revision ID: 7de929cc0829
Revises: 
Create Date: 2018-09-21 18:28:22.843259
...
def upgrade():
    ...
    sa.Column('create_time', sa.TIMESTAMP(), server_default=sa.text("(datetime('now','localtime'))"), nullable=True),
